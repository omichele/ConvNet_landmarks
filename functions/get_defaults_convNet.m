...
ds.conf.params.reRank_num = 0;          % 20 it's ok
...
ds.conf.static_mem = 0;             % it says with at test time the algorithm keeps storing images in the memory
...
ds.conf.params.frame_tolerance = 0;  %  30 it's ok    It affect only the plotting online. And the pr curve offline
