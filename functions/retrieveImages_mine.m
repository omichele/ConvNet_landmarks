...
function [imageIDs, scores, varargout] = retrieveImages_mine(queryImage, imageIndex, varargin)
...
[imageIDs, scores, queryWords, dimensions, dist] = search_and_update(imageIndex, queryImage, ...
...
validateattributes(imageIndex, {'invertedImageIndex_mine'}, {}, mfilename, 'imageIndex',2);
